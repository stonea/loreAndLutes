...
{	//Draw everything important for the edit
	...
	//Reset the console state
		mypoConsole->SetViewport(0, mypoConsole->ViewportY());
}
//P.. ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ...P
...
{	//Vars
	...
	//Set the viewport x
		if(mypoText->CursorColumn() > mypoConsole->ViewportX() + mypoConsole->ViewWidth())
		{	mypoConsole->SetViewport(mypoText->CursorColumn() - mypoConsole->ViewWidth(), mypoConsole->ViewportY());
		}
		if(mypoText->CursorColumn() < mypoConsole->ViewportX())
		{	mypoConsole->SetViewport(mypoText->CursorColumn(), mypoConsole->ViewportY());
		}
...
{	//Vars
	...
	//Draw the cursor here
		mypoConsole->Screen()->DrawFillRectangle(iPixX, iPixY, 2, 14, COLOR_WHITE, 255);
}
//P.. ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ...P
...
{	//Vars
	...
	//Get a key
		...
		{	iLastKey = iKey;
			...
			CheckCursorPosition();
			iKey = myoInput.GetKey(250, 0);			
		}
}
//P.. ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ...P
void TE_TextEditor::HandleMouse()
{	//If the mouse is down
	if(myoInput.GetMouseButton(ASFC_Input::MOUSE_LEFT) || myoInput.GetMouseButton(ASFC_Input::MOUSE_RIGHT))
	{	//Translate the cursor position
		...
		//Wait for the button to be released
			while(myoInput.GetMouseButton(ASFC_Input::MOUSE_LEFT) || myoInput.GetMouseButton(ASFC_Input::MOUSE_RIGHT))
				myoInput.Update();
	}
}
//P.. ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ...P
