					...
					case STATE_PLAY:
     				{	//Run the game
     					...
     					//Bring the screen back in
							...
							//Do a fade effect
								myoEffects.Blend(oSurf1, oSurf2, *mypoScreen, 15, 12);
	     					//fExit = true;
          			}break;
...
//... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ...
void LSTART_Starter::BringInImage(string sImage)
{	//Save pictures of the map
		...
		//If we're adding an image add it
			...
			oAddImage.LoadImage(sImage, COLOR_BLUE);
			oAddImage.BlitTo(*mypoScreen, 10, 10);
		ASFC_Surface oSurf2(mypoScreen->GetWidth(), mypoScreen->GetHeight(), mypoScreen->GetBpp());
		oSurf2.Blit(*mypoScreen, 0, 0);

	//Decide what to do based on which effect
		myoEffects.Blend(oSurf1, oSurf2, *mypoScreen, 0, 50);
}
