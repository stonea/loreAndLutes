...
{	public:
	...
	//- [Maps] -
		...
		LOOPPORT(LOOPCMDPRT_MoveToMap,				LL_LOOPLib_Lore,	LOOPCMD_MoveToMap);			//IIII
	//- [Date\Time] -
	...
	//- [Player Commands] -
		...
		LOOPPORT(LOOPCMDPRT_GetHP,					LL_LOOPLib_Lore,	LOOPCMD_GetHP);				//[I]I
		...
		LOOPPORT(LOOPCMDPRT_GetMaxHP,				LL_LOOPLib_Lore,	LOOPCMD_GetMaxHP);			//[I]I
	//- [Inventory] -
