...
{	//Set defaults
	...
	//- [Graphics] -
		...
		poLOOP->NewCommand("LoadFont",			&LOOPCMDPRT_LoadFont,			this);	//[I]S
	...
	//- [Player Commands] -
		...
		poLOOP->NewCommand("SetHP",					&LOOPCMDPRT_SetHP,			this);			//II
			poLOOP->AddParam(PARAM_INT);
			poLOOP->AddParam(PARAM_INT);
		poLOOP->NewCommand("GetHP",					&LOOPCMDPRT_GetHP,			this);			//[I]I
			poLOOP->AddParam(PARAM_INT_REF);
			poLOOP->AddParam(PARAM_INT);
		...
		poLOOP->NewCommand("SetMaxHP",				&LOOPCMDPRT_SetMaxHP,		this);			//II
			poLOOP->AddParam(PARAM_INT);
			poLOOP->AddParam(PARAM_INT);
		poLOOP->NewCommand("GetMaxHP",				&LOOPCMDPRT_GetMaxHP,		this);			//[I]I
			poLOOP->AddParam(PARAM_INT_REF);
			poLOOP->AddParam(PARAM_INT);
	//- [Inventory] -
...
{	//If the player num is nonexistant do nada
		if(oInfo.GrabInt(1) < 0 || oInfo.GrabInt(1) >= mypoGame->Player().PartyMembers().Length())
			return;

	oInfo.SetInt(oInfo.GrabIntRef(0), mypoGame->Player().PartyMembers()[oInfo.GrabInt(1)].HP());
}
//... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ...
//II
...
{	//If the player num is nonexistant do nada
	...
	oInfo.SetInt(oInfo.GrabIntRef(0), mypoGame->Player().PartyMembers()[oInfo.GrabInt(1)].MaxHP());
}
//---------------------------------------------------------------------------------------- [Inventory] -
//I
