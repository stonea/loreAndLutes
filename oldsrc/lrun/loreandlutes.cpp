					...
					//- [Go Map North] -
						...
						{	//Capture the player's position and get the effect
							...
							//If theres a map to the north
								if(myoGame.TerrainMap().MapNorth() != myoGame.MapSet().NO_MAP)
    							{	//Load the map
					...
					//- [Go Map South] -
						...
						{	//Capture the player's position and get the effect
							...
							//If theres a map to the south
								if(myoGame.TerrainMap().MapSouth() != myoGame.MapSet().NO_MAP)
					...
					//- [Go Map West] -
						...
						{	//Capture the player's position and get the effect
							...
							//If theres a map to the west
								if(myoGame.TerrainMap().MapWest() != myoGame.MapSet().NO_MAP)
					...
					//- [Go Map East] -
						...
						{	//Capture the player's position and get the effect
    						...
    						//Load the Eastern map (if legal)
		    					if(myoGame.TerrainMap().MapEast() != myoGame.MapSet().NO_MAP)
