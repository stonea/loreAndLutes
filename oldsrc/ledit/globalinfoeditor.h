...
*/
#ifndef LEDIT_GLOBALINFOEDITOR_H_
#define LEDIT_GLOBALINFOEDITOR_H_
...
//												 Prototype
//¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤
class LEDIT_GlobalInfoEditor : public LEDIT_ConsoleEditor
{	public:
	//- [Construction] -
	...
	//- [Editting] -
		...
		MEMVAR_SETGET(SetPlayerSetEdit, PlayerSetEdit, LEDIT_PlayerSetEditor*, mypoPlayerSetEdit);
		void EditInfo();
	...
	//Type
		enum EDITOPTIONS
		{	EDITOPTION_START_MAP = 0,
			EDITOPTION_DEATH_MAP,
			EDITOPTION_PLAYER,
			EDITOPTION_HEAL_CHANCE,
			EDITOPTION_HEAL_AMOUNT,
	...
	//Vars
		...
		LEDIT_PlayerSetEditor* mypoPlayerSetEdit;
};
