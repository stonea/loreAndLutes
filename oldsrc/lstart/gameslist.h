/* Protected under the GNU General Public License read and see copying.txt for details
   ...
   `_______,------------------------------------------- -------- ---- -- --- - - -   -     -       -
	Description: 
*/
#ifndef LSTART_GAMESLIST_H_
#define LSTART_GAMESLIST_H_
...
//												 Prototype
//¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤
class LSTART_GamesList : public ASFC_Console
{	public:
	//- [Constructor] -
		LSTART_GamesList();
	...
	//- [Listing] -
		...
		string Selection();
		int  CurrentRow();
		void AddGame(string sGameName);
		bool IsGameWithName(string sGameName);
	...
	//Vars
		...
		ASFC_LinkedList<string> mylsGames;
};
